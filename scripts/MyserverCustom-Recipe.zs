...
AssemblyLine.addRecipe(<DraconicEvolution:draconicChest>  , 1728000,
                        [<GraviSuite:graviChestPlate>, <miscutils:itemRingChromaticGlass>, <eternalsingularity:eternal_singularity>, <Avaritia:big_pearl>,
                          <ThaumicHorizons:focusAnimation>, <gregtech:gt.metaitem.03:32130>, <gregtech:gt.metaitem.01:32657>*16, <gregtech:gt.metaitem.01:32647>*32,
                          <gregtech:gt.metaitem.01:32647>*32, <ThaumicTinkerer:kamiResource:5>*16, <ThaumicTinkerer:kamiResource:5>*16,
                          <gregtech:gt.metaitem.02:16984>*64, <gregtech:gt.metaitem.02:16984>*64, <gregtech:gt.metaitem.02:16984>*64, <gregtech:gt.metaitem.02:16984>*64],
                        [<liquid:ic2uumatter>*64000, <liquid:ic2coolant>*100000, <liquid:molten.neutronium>*18432, <liquid:plasma.americium>*92160],
                            <ExtraUtilities:angelRing:1> , 72000, 8000000 );
Assembler.addRecipe(<ExtraUtilities:angelRing>   ,<ExtraUtilities:angelRing:*>, <Thaumcraft:ItemBathSalts>,       <liquid:water>*10000              ,1200, 122800);
Assembler.addRecipe(<ExtraUtilities:angelRing:2> ,<ExtraUtilities:angelRing:*>, <Thaumcraft:blockCustomPlant:4>,  <liquid:ic2distilledwater>*10000  ,1200, 122800);
Assembler.addRecipe(<ExtraUtilities:angelRing:3> ,<ExtraUtilities:angelRing:*>, <DraconicEvolution:dragonHeart>,  <liquid:endergoo>*10000           ,1200, 122800);
Assembler.addRecipe(<ExtraUtilities:angelRing:4> ,<ExtraUtilities:angelRing:*>, <Avaritia:Singularity:1>,         <liquid:molten.gold>*10000        ,1200, 122800);
